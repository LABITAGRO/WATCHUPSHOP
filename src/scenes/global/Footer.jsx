            ...
            >
                <Box width={mobilePoint ? "clamp(50%, 15%, 40%)" : "clamp(30%, 15%, 40%)"}>
                    <Box
                        ...
                        mb="20px"
                    >
                        <Typography variant="h4"> Watchupshop
                        </Typography>
                    </Box>
                    <Box
                        color="#151515"
                    >
                       "WatchUpShop: Unveiling Timeless Elegance. Buy, sell, and exchange vintage watches with a touch of personal history. Every tick, a tale; every watch, a journey."
                    </Box>
                    <Box
                        display="flex"
                        alignItems="center"
